...
if __name__ == "__main__":
    ...
    # opt.video_dir = 'lab_results_tim'
    # opt.video_dir = 'video_for_predictions/marq_1.mp4'
    # opt.video_dir = 'video_for_predictions/marq_2.mp4'
    # opt.video_dir = 'video_for_predictions/voids_mandate.mp4'
