...
if __name__ == '__main__':
    ...
    dataset_path = '../../../..'
    # train_img_xml_dir = dataset_path + "/mask_data_test"
    # save_json_train = dataset_path + "/converted_mask_data/annotations/instances_train2017.json"
    
    train_img_xml_dir = dataset_path + "/mask_data_generated/train"
    save_json_train = dataset_path + "/converted_mask_data/annotations/instances_train2017.json"
    
    val_img_xml_dir = dataset_path + "/mask_data_generated/val"
    save_json_val = dataset_path + "/converted_mask_data/annotations/instances_val2017.json"
    ...
    print("convert done, now you can use 'python tools/show_coco_anns.py' to visualized the annotations")
