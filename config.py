...
opt.exp_id = "face_mask_CSPDarknet-s_640x640"  # experiment name, you can change it to any other name
...
opt.load_model = 'yolox_coco_weights/yolox-s.pth' #pre-trained model path
# pre-trained weights
...
# mask dataset has 3 classes
opt.label_name = ['with_mask', 'mask_incorrect', 'without_mask']
...
opt.print_iter = 500  # print loss every 1 iteration
